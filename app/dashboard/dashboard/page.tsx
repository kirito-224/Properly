...
const upcomingPayments = [
	{ id: 1, tenant: 'Sarah Johnson', unit: 'Unit 3A', amount: 1700, dueDate: '2025-11-05', status: 'pending' as const },
	{ id: 2, tenant: 'Michael Chen', unit: 'Unit 5B', amount: 1550, dueDate: '2025-11-05', status: 'pending' as const },
	{ id: 3, tenant: 'Emily Davis', unit: 'Unit 2C', amount: 1800, dueDate: '2025-11-10', status: 'pending' as const },
	{ id: 4, tenant: 'James Wilson', unit: 'Unit 1A', amount: 1600, dueDate: '2025-11-15', status: 'overdue' as const },
]
	...
	return (
		<div className="space-y-6">
			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
				...
				<div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
					<div className="flex items-center justify-between mb-6">
						<h2 className="text-lg font-semibold text-gray-900">Upcoming Rent Payments</h2>
						<Link
							href="/dashboard/finances/transactions"
							className="text-sm font-medium text-blue-600 hover:text-blue-700 inline-flex items-center"
						>
						...
						{upcomingPayments.map((payment) => (
							...
							>
								<div className="flex-1 min-w-0">
									...
									<p className="text-xs text-gray-500">
										{payment.unit} • Due {payment.dueDate}
									</p>
								</div>
